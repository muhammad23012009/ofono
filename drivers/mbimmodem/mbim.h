...
#define MBIM_CID_MS_UICC_LOW_LEVEL_ACCESS_OPEN_CHANNEL	2
#define MBIM_CID_MS_UICC_LOW_LEVEL_ACCESS_CLOSE_CHANNEL 3
#define MBIM_CID_MS_UICC_LOW_LEVEL_ACCESS_APDU	4
